...
// Browser discovery lives in one place - the pre-deploy check scripts need
// exactly the same logic and used to hardcode a Windows path instead.
const { chromiumCandidates, usableBrowser } = require('../lib/chromium');
