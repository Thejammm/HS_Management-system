...
// The safety net under every write here lives in one place, because the
// offline push needs exactly the same rules - see lib/state-history.js.
const { keepPrevious: _keepPrevious } = require('../lib/state-history');
